...
%define version 4.7.2~rc2
%define upstream_version 4.7.2rc2
...
%changelog
* Wed Oct 30 2024 Josep Llaneras <josep.llaneras@proton.ch> 4.7.2~rc2
- Rename missing "Logging in" message to "Signing in"
